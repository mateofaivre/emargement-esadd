var options = {
  ...
  var nomDiplomeModal = document.querySelector('#nomDiplomeModal')
  var nomDiplome = document.querySelectorAll('.nomDiplomes')
  var idDiplome = document.querySelectorAll('.ids')
  ...
  function stopScroll(){
      ...
      if (body.style.overflow != 'hidden'){
          ...
          nomDiplomeModal.innerHTML = nomDiplome[nbLinkAllClass].innerHTML
          validerModal.href+= idDiplome[nbLinkAllClass].innerHTML
      
      }
      else{   
          body.style.overflow = 'auto';
          nomDiplomeModal.innerHTML = "" 
      }

...
<body>
    ...
    <?php
        ...
        $stmt = $dbh->prepare("SELECT idUser, nomUser, prenomUser FROM user WHERE isProf = 1 AND isActualUser = 1 ORDER by nomUser");
    ...
    <?php }
     if ($_SESSION['done_message'] != "" && isset($_SESSION['done_message'])){
      ?><p class="doneMessage"> <?php  echo $_SESSION['done_message']; ?> </p><?php
        ...
        <div id="containerList">
          ...
          <div class="containerTools">
            ...
            <div class="filtres">
              ...
              <a href="../eleves/eleves.php" class="links">Élèves<i class="far fa-arrow-right"></i></a>
              <a href="anciens-profs.php" class="links">Anciens profs<i class="far fa-arrow-right"></i></a>
        ...
        <a href="../eleves/eleves.php" class="linksPhone">Élèves<i class="far fa-arrow-right"></i></a>
        <a href="anciens-profs.php" class="linksPhone">Anciens profs<i class="far fa-arrow-right"></i></a>

        <div id="modalWindow" class="modal">
            <div class="modal-content">

                <p>Confirmez-vous la suppression de <span id="nomProfModal"></span> <span id="prenomProfModal"></span> ? </p>    
              
                <div class="actionBtns">
                    <a href="#"  name="annuler" id="annulerModal" class="btnModal">Annuler</a>
                    <a href="profs.php?action=delete&amp;id=" name="valider" id="validerModal" class="btnModal">Valider</a>
                </div>

...
<body>
    ...
    <?php
        ...
        $stmt = $dbh->prepare("SELECT idUser, nomUser, prenomUser FROM user WHERE isProf = 0 AND isActualUser = 0 ORDER by nomUser");
...
<nav class="navbar">
  ...
  <?php if (isset($_SESSION['error_message'])){
    ...
    ?><p class="doneMessage"> <?php  echo $_SESSION['done_message']; ?> </p><?php
        ...
        <main>
          <div id="containerList">
            ...
            <div class="containerTools">
              <h2 class="hRole">Anciens élèves</h2>
              ...
              <div class="filtres">
                ...
                <a href="eleves.php" class="links">Élèves actuels<i class="far fa-arrow-right"></i></a>
              </div>
            </div>
          <ul class="list">
        ...
        <a href="eleves.php" class="linksPhone">Élèves actuels<i class="far fa-arrow-right"></i></a>

        <div id="modalWindow" class="modal">
            <div class="modal-content">
                <p>Confirmez-vous l'ajout de <span id="nomEleveModal"></span> <span id="prenomEleveModal"></span> ? </p>    
              
                <div class="actionBtns">
                    <a href="#"  name="annuler" id="annulerModal" class="btnModal">Annuler</a>
                    <a href="anciens-eleves.php?action=add&amp;id=" name="valider" id="validerModal" class="btnModal">Valider</a>
                </div>
